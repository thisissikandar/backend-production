...
const generateAccessAndRefereshTokens = async(userId) =>{
  try {
      ...
      throw new ApiErrorHaandler(500, "Something went wrong while generating referesh and access token")
  }
}
...
const loginUser = asyncHandler(async (req, res) =>{
  ...
  if (!email && !password) {
      throw new ApiErrorHaandler(400, "username or email is required")
  }
